...
use Test\UserBundle\Entity\Role;
use Test\UserBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestUserBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("TestUserBundle:Role:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestUserBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestUserBundle:Role:edit.html.twig")
     */
